...
import aquality.appium.mobile.configuration.DriverSettings;
...
public class ApplicationProfile implements IApplicationProfile {
    ...
    public PlatformName getPlatformName() {
        ...
        String platform = platformName == null
                ? settingsFile.getValue("/platformName").toString()
                : platformName;
        return PlatformName.valueOf(String.valueOf(platform).toUpperCase());
