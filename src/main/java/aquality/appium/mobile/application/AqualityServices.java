...
import aquality.appium.mobile.application.IApplicationFactory;
import aquality.appium.mobile.application.LocalApplicationFactory;
import aquality.appium.mobile.application.MobileModule;
import aquality.appium.mobile.application.RemoteApplicationFactory;
...
public class AqualityServices extends aquality.selenium.core.applications.AqualityServices<Application> {
    ...
    private static final ThreadLocal<aquality.appium.mobile.application.AqualityServices> INSTANCE_CONTAINER = ThreadLocal.withInitial(aquality.appium.mobile.application.AqualityServices::new);

    private IApplicationFactory applicationFactory;

    private AqualityServices() {
        super(aquality.appium.mobile.application.AqualityServices::getApplication, () -> new MobileModule(aquality.appium.mobile.application.AqualityServices::getApplication));
    }

    private AqualityServices(MobileModule module) {
        super(aquality.appium.mobile.application.AqualityServices::getApplication, () -> module);
    }

    private static aquality.appium.mobile.application.AqualityServices getInstance() {
    ...
    public static Application getApplication() {
        return getInstance().getApp(injector -> startApplication());
    }
    ...
    public static void initInjector(MobileModule module) {
        ...
        INSTANCE_CONTAINER.set(new aquality.appium.mobile.application.AqualityServices(module));
    }
