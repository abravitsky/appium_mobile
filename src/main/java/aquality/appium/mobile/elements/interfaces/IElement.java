...
public interface IElement extends aquality.selenium.core.elements.interfaces.IElement {
     ...
     */
    <T extends aquality.appium.mobile.elements.interfaces.IElement> T findChildElement(By childLoc, String name, ElementType elementType, ElementState state);
     ...
     * @return found child element
     */
    default <T extends aquality.appium.mobile.elements.interfaces.IElement> T findChildElement(By childLoc, ElementType elementType, ElementState state) {
     ...
     * @return found child element
     */
    default <T extends aquality.appium.mobile.elements.interfaces.IElement> T findChildElement(By childLoc, ElementType elementType) {
     ...
     * @return found child element
     */
    default <T extends aquality.appium.mobile.elements.interfaces.IElement> T findChildElement(By childLoc, String name, ElementType elementType) {
